...
def train(loader, model, epochs=5, batch_size=2, show_loss=True, augmenter=False):
...
if __name__ == "__main__":
	...
	loader = Loader.Loader(dataFolderPath=dataset_path, n_classes=n_classes, problemType='segmentation', width=128, height=128)
