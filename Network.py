...
def conv2d(x, filters, filter_size, padding='same', strides=(1, 1), dilation_rate=(1, 1), training=True, last =False):
...
def encoder_decoder_example(input_x=None, n_classes=20, training=True):
    ...
    x4 = conv2d(x3, 64, (3, 3), padding='same', strides=(2, 2), dilation_rate=(1, 1), training=training)
    ...
    x12 = deconv2d_bn(x11, 128, (3, 3), padding='same', strides=(1, 1),  training=training)
    ...
    x15 = deconv2d_bn(x14, 32, (3, 3), padding='same', strides=(1, 1),  training=training)
