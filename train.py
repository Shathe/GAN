...
parser.add_argument("--width", help="width", default=240)
parser.add_argument("--height", help="height", default=180)
...
label = tf.placeholder(tf.float32, shape=[None, height, width, n_classes], name='output')  # the n_classes + 1 is for the ignore classes
